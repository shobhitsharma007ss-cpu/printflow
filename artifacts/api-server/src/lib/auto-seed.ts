...
export async function autoSeedIfEmpty(): Promise<void> {
  ...
  try {
    ...
    const [
      ...
      { machineName: "Komori LA37", machineCode: "KOM-LA37", machineType: "printing", maxPaperWidth: "25in", maxPaperLength: "37in", speedPerHour: 12000, capabilities: ["print", "uv-single-pass", "texture", "drip-off"], status: "idle", operatorName: "Operator 1", colorUnits: 4, description: "Prints and applies UV coating, texture, or drip-off in a single pass. 12 000 sph. Best for UV/special finish jobs.", notes: "Primary machine for UV/special finish jobs." },
      { machineName: "Komori GL37", machineCode: "KOM-GL37", machineType: "printing", maxPaperWidth: "25in", maxPaperLength: "37in", speedPerHour: 13000, capabilities: ["print", "varnish-single-pass"], status: "running", operatorName: "Operator 2", colorUnits: 4, description: "Prints and applies varnish in a single pass. 13 000 sph. Primary machine for varnish jobs.", notes: "Primary machine for varnish jobs." },
      { machineName: "Planeta Super Variant", machineCode: "PLAN-SV", machineType: "printing", maxPaperWidth: "28in", maxPaperLength: "40in", speedPerHour: 5000, capabilities: ["print", "non-woven"], status: "idle", operatorName: "Operator 3", colorUnits: 4, description: "Legacy press. 5 000 sph. Non-woven fabric and basic print only.", notes: "Not suitable for modern packaging jobs." },
